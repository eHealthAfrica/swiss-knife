...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventType.severity'
        db.add_column(u'core_eventtype', 'severity',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventType.icon_name'
        db.add_column(u'core_eventtype', 'icon_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventType.severity'
        db.delete_column(u'core_eventtype', 'severity')

        # Deleting field 'EventType.icon_name'
        db.delete_column(u'core_eventtype', 'icon_name')
    ...
    models = {
        ...
        u'core.eventtype': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'icon_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
