...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.vehicle'
        db.add_column(u'core_event', 'vehicle',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Vehicle'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.vehicle'
        db.delete_column(u'core_event', 'vehicle_id')
