...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'core', ['Driver'])

        # Adding model 'Vehicle'
        db.create_table(u'core_vehicle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('changed_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('plate_number', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('vehicle_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('tank_size', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('fuel_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('last_driver', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Driver'], null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['Vehicle'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'core_driver')

        # Deleting model 'Vehicle'
        db.delete_table(u'core_vehicle')
    ...
    models = {
        ...
        u'core.vehicle': {
            ...
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'plate_number': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
